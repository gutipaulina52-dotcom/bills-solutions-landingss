// page.tsx — Bills Solutions Center — COMPLETE & READY TO DEPLOY
// Replace this file at: app/page.tsx
...
function App() {
    ...
    return (
      <div style={{ position: 'fixed', inset: 0, background: '#050a12', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', zIndex: 9999 }}>
        <div style={{ position: 'relative', width: '200px', height: '200px', marginBottom: '40px' }}>
          <div style={{ position: 'absolute', inset: '-8px', borderRadius: '50%', background: 'conic-gradient(from 0deg, #10b981, #d7263d, #f59e0b, #10b981)', animation: 'spin 3s linear infinite', opacity: 0.7 }} />
          <div style={{ position: 'relative', width: '200px', height: '200px', borderRadius: '50%', overflow: 'hidden', border: '3px solid rgba(16,185,129,0.5)', boxShadow: '0 0 40px rgba(16,185,129,0.3)' }}>
            <img src={LOGO_URL} alt="Bills Solutions Center" style={{ width: '100%', height: '100%', objectFit: 'cover', position: 'absolute', top: 0, left: 0 }} />
            <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: `${fillLevel}%`, background: 'linear-gradient(to top, rgba(16,185,129,0.85), rgba(215,38,61,0.5))', transition: 'height 0.1s linear', mixBlendMode: 'multiply' }} />
          </div>
        </div>
        ...
        <div style={{ width: '200px', height: '3px', background: 'rgba(255,255,255,0.1)', borderRadius: '2px', overflow: 'hidden' }}>
          <div style={{ height: '100%', width: `${fillLevel}%`, background: 'linear-gradient(90deg, #10b981, #d7263d)', transition: 'width 0.1s linear', borderRadius: '2px' }} />
        </div>
  ...
  return (
    <main style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif', background: 'linear-gradient(180deg,#040912 0%,#07111f 45%,#050a12 100%)', color: '#fff', overflowX: 'hidden' }}>

      {/* ── NAV ── */}
      <nav style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 1000, background: scrolled ? 'rgba(5,10,18,0.97)' : 'transparent', backdropFilter: scrolled ? 'blur(20px)' : 'none', borderBottom: scrolled ? '1px solid rgba(16,185,129,0.15)' : 'none', transition: 'all 0.5s', height: scrolled ? '70px' : '90px', display: 'flex', alignItems: 'center', padding: '0 5%' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <img src={LOGO_URL} alt="Logo" style={{ width: '52px', height: '52px', borderRadius: '50%', objectFit: 'cover', border: '2px solid #d7263d', boxShadow: '0 0 14px rgba(215,38,61,0.4)' }} />
            <div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '35px' }}>
            <div style={{ display: 'flex', gap: '28px', fontSize: '14px', fontWeight: '500', color: 'rgba(255,255,255,0.7)' }}>
              {[['#services','Services'],['#gallery','Gallery'],['#reviews','Reviews'],['#contact','Contact']].map(([href, label]) => (
                <a key={href} href={href} style={{ color: 'inherit', textDecoration: 'none', transition: '0.2s' }}
                  onMouseOver={e => e.currentTarget.style.color = '#10b981'}
                  onMouseOut={e => e.currentTarget.style.color = 'rgba(255,255,255,0.7)'}>{label}</a>
              ))}
            </div>
            <a href={WA_LINK} target="_blank" rel="noreferrer" style={{ background: 'linear-gradient(135deg,#10b981,#059669)', color: '#fff', padding: '12px 28px', borderRadius: '8px', fontWeight: '700', textDecoration: 'none', fontSize: '14px', boxShadow: '0 4px 15px rgba(16,185,129,0.35)' }}>GET STARTED</a>
          </div>
        </div>
      </nav>

      {/* ── HERO ── */}
      <section style={{ position: 'relative', minHeight: '100vh', display: 'flex', alignItems: 'center', padding: '0 5%', background: `linear-gradient(120deg,rgba(4,9,18,.85),rgba(7,17,31,.75),rgba(5,107,85,.22)),radial-gradient(circle at 85% 20%,rgba(215,38,61,.2),transparent 22%),url("${HERO_BG}")`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', width: '100%', paddingTop: '80px' }}>
          <div style={{ maxWidth: '740px' }}>
            ...
            <h1 style={{ fontSize: 'clamp(40px,6vw,72px)', fontWeight: '900', lineHeight: '1.05', marginBottom: '28px', letterSpacing: '-2px' }}>
              ...
              <span style={{ background: 'linear-gradient(90deg,#10b981,#ffffff,#d7263d)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                Rent & Bills
              </span>
            </h1>
            ...
            <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', alignItems: 'center' }}>
              <a href={WA_LINK} target="_blank" rel="noreferrer" style={{ background: 'linear-gradient(135deg,#10b981,#059669)', color: '#fff', padding: '20px 45px', borderRadius: '12px', fontSize: '18px', fontWeight: '800', textDecoration: 'none', boxShadow: '0 10px 40px rgba(16,185,129,0.4)', display: 'flex', alignItems: 'center', gap: '12px' }}>
        ...
        <div style={{ position: 'absolute', bottom: '40px', left: '5%', right: '5%', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '20px', borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '30px' }}>
      ...
      <section style={{ padding: '120px 5%' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }}>
          <div style={{ borderRadius: '30px', overflow: 'hidden', height: '600px', boxShadow: '0 30px 60px rgba(0,0,0,0.5)', background: `url("${ABOUT_IMG}")`, backgroundSize: 'cover', backgroundPosition: 'center' }} />
          <div>
            ...
            {[
              ...
              <div key={item.title} style={{ display: 'flex', gap: '20px', background: 'rgba(10,15,28,0.85)', padding: '22px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.08)', marginBottom: '16px', transition: '0.3s' }}
                onMouseOver={e => { e.currentTarget.style.borderColor = 'rgba(215,38,61,0.3)'; e.currentTarget.style.background = 'rgba(215,38,61,0.06)'; }}
                onMouseOut={e => { e.currentTarget.style.borderColor = 'rgba(255,255,255,0.08)'; e.currentTarget.style.background = 'rgba(10,15,28,0.85)'; }}>
      ...
      <section id="services" style={{ padding: '120px 5%', background: 'rgba(8,15,26,0.8)', textAlign: 'center' }}>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(300px,1fr))', gap: '25px' }}>
          {[
            ...
            <div key={s.name} style={{ padding: '40px', background: 'rgba(10,15,28,0.85)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '25px', transition: '0.4s', textAlign: 'left', cursor: 'pointer' }}
              onMouseOver={e => { e.currentTarget.style.background = 'rgba(215,38,61,0.08)'; e.currentTarget.style.transform = 'translateY(-10px)'; e.currentTarget.style.borderColor = 'rgba(215,38,61,0.35)'; }}
      ...
      <section id="gallery" style={{ padding: '120px 5%' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '24px', alignItems: 'stretch' }}>
            <div style={{ minHeight: '540px', borderRadius: '28px', overflow: 'hidden', position: 'relative', border: '1px solid rgba(255,255,255,0.08)', boxShadow: '0 30px 80px rgba(0,0,0,0.35)', backgroundImage: `linear-gradient(to top,rgba(4,9,18,0.45),rgba(4,9,18,0.08)),url("${GALLERY_IMAGES[activeGallery]}")`, backgroundSize: 'cover', backgroundPosition: 'center', transition: 'all 0.7s ease' }}>
              <div style={{ position: 'absolute', left: '30px', bottom: '30px', maxWidth: '540px' }}>
                <div style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', padding: '10px 16px', borderRadius: '999px', background: 'rgba(255,255,255,0.12)', backdropFilter: 'blur(10px)', fontSize: '12px', fontWeight: '800', letterSpacing: '2px', marginBottom: '18px' }}>✓ VERIFIED VISUAL BRANDING</div>
                <h3 style={{ fontSize: '28px', fontWeight: '800', marginBottom: '12px' }}>A Premium Experience Your Clients Can Feel Instantly</h3>
                <p style={{ color: 'rgba(255,255,255,0.78)', lineHeight: '1.8', fontSize: '15px' }}>Professional service, real results, and a team that's always available for you.</p>
              </div>
            </div>
            <div style={{ display: 'grid', gap: '24px' }}>
              {GALLERY_IMAGES.map((img, index) => (
                <div key={img} onClick={() => setActiveGallery(index)} style={{ minHeight: '120px', borderRadius: '24px', overflow: 'hidden', cursor: 'pointer', border: activeGallery === index ? '2px solid #d7263d' : '1px solid rgba(255,255,255,0.08)', backgroundImage: `linear-gradient(to top,rgba(4,9,18,0.35),rgba(4,9,18,0.05)),url("${img}")`, backgroundSize: 'cover', backgroundPosition: 'center', boxShadow: activeGallery === index ? '0 15px 40px rgba(215,38,61,0.25)' : 'none', transform: activeGallery === index ? 'scale(1.02)' : 'scale(1)', transition: 'all 0.35s ease' }} />
              ))}
            </div>
          </div>
        </div>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '70px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '15px', flexWrap: 'wrap' }}>
              <div style={{ display: 'flex', gap: '4px' }}>{[1,2,3,4,5].map(i => <span key={i} style={{ color: '#f59e0b', fontSize: '24px' }}>★</span>)}</div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(340px,1fr))', gap: '25px' }}>
            {reviews.map(r => (
              <div key={r.name} style={{ background: 'rgba(10,15,28,0.9)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '24px', padding: '35px', transition: '0.3s' }}
                onMouseOver={e => { e.currentTarget.style.borderColor = 'rgba(215,38,61,0.3)'; e.currentTarget.style.background = 'rgba(215,38,61,0.06)'; }}
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '20px' }}>
                  <div style={{ display: 'flex', gap: '3px' }}>{[1,2,3,4,5].map(i => <span key={i} style={{ color: '#f59e0b', fontSize: '16px' }}>★</span>)}</div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                  <div style={{ width: '50px', height: '50px', borderRadius: '50%', background: r.color, display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: '800', fontSize: '16px', flexShrink: 0 }}>{r.avatar}</div>
                  <div>
          ...
          <div style={{ textAlign: 'center', marginTop: '60px' }}>
            <a href={WA_LINK} target="_blank" rel="noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '12px', background: 'linear-gradient(135deg,#10b981,#059669)', color: '#fff', padding: '20px 50px', borderRadius: '12px', fontSize: '18px', fontWeight: '800', textDecoration: 'none', boxShadow: '0 10px 40px rgba(16,185,129,0.4)' }}>
      ...
      {/* ── CTA ── */}
      <section id="contact" style={{ padding: '150px 5%', textAlign: 'center', background: `linear-gradient(rgba(215,38,61,0.82),rgba(120,10,20,0.92)),url("${CTA_BG}")`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <img src={LOGO_URL} alt="Logo" style={{ width: '110px', height: '110px', borderRadius: '50%', objectFit: 'cover', marginBottom: '30px', border: '3px solid rgba(255,255,255,0.5)', boxShadow: '0 10px 40px rgba(0,0,0,0.4)' }} />
        ...
        <a href={WA_LINK} target="_blank" rel="noreferrer" style={{ background: '#fff', color: '#d7263d', padding: '25px 60px', borderRadius: '15px', fontSize: '22px', fontWeight: '900', textDecoration: 'none', display: 'inline-block', boxShadow: '0 15px 50px rgba(0,0,0,0.3)' }}>
          💬 CHAT WITH US NOW
        </a>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '40px', alignItems: 'flex-start' }}>
          <div style={{ maxWidth: '380px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
              <img src={LOGO_URL} alt="Logo" style={{ width: '48px', height: '48px', borderRadius: '50%', objectFit: 'cover', border: '2px solid #d7263d' }} />
      ...
      {/* ── FLOATING WHATSAPP ── */}
      <a href={WA_LINK} target="_blank" rel="noreferrer" style={{ position: 'fixed', bottom: '35px', right: '35px', zIndex: 2000, width: '70px', height: '70px', background: '#25d366', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '34px', boxShadow: '0 10px 30px rgba(37,211,102,0.5)', textDecoration: 'none', animation: 'pulse 2s infinite' }}>💬</a>
