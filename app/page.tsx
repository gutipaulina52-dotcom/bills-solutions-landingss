  ...
  return (
    <div style={{
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(300px,1fr))', gap: '25px' }}>
          {[
            ...
            <div key={s.name} style={{
              ...
              onMouseOver={e => { e.currentTarget.style.background = 'rgba(16,185,129,0.08)'; e.currentTarget.style.transform = 'translateY(-10px)'; e.currentTarget.style.borderColor = 'rgba(16,185,129,0.3)'; }}
      ...
      <section id="gallery" style={{ padding: '120px 5%' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            <div style={{ color: '#10b981', fontSize: '13px', fontWeight: '800', letterSpacing: '5px', marginBottom: '15px' }}>TRUST IN ACTION</div>
              ...
              {GALLERY_IMAGES.map((img, index) => (
                <div
                  ...
                  style={{
                    ...
                    border: activeGallery === index ? '2px solid #10b981' : '1px solid rgba(255,255,255,0.08)',
                    backgroundImage: `linear-gradient(to top,rgba(4,9,18,0.35),rgba(4,9,18,0.05)),url("${img}")`,
                    backgroundSize: 'cover', backgroundPosition: 'center',
                    boxShadow: activeGallery === index ? '0 15px 40px rgba(16,185,129,0.22)' : 'none',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(340px,1fr))', gap: '25px' }}>
            {reviews.map(r => (
              <div key={r.name} style={{
                ...
                onMouseOver={e => { e.currentTarget.style.borderColor = 'rgba(16,185,129,0.3)'; e.currentTarget.style.background = 'rgba(16,185,129,0.06)'; }}
      ...
      <style>{`
        ...
        @keyframes glowShift {
          0% { filter: drop-shadow(0 0 0 rgba(16,185,129,0.15)); }
          50% { filter: drop-shadow(0 0 18px rgba(59,130,246,0.18)); }
          100% { filter: drop-shadow(0 0 0 rgba(215,38,61,0.12)); }
        }
